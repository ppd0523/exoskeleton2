...
void encoder_init() {
	...
	//GPIO_Mode_AF_PP; //GPIO_Mode_AF_PP; // GPIO_Mode_IN_FLOATING; GPIO_Mode_IPD,GPIO_Mode_AF_OD
...
//	GPIO_PinRemapConfig(GPIO_PartialRemap_TIM4, ENABLE);
	...
	TIM_TimeBaseStructure.TIM_Period = (65536 - 1); // pgm-12 encode_env.pos (ppr * step * gear) = 13*2*264 = 768
